...
fun main(args: Array<String>) {
    ...
    val f3 = {x: Float, y: Float -> x*x + x*y + y*y - 4*x + 3*y}
    val f4 = {x: Float, y: Float -> (x*x - y)*(x*x - y) + (y - 0.6f)*(y - 0.6f)}
    var res: Float
